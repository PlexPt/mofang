...
<div id="wrapper">
                        ...
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear">
                                    <span class="block m-t-xs" style="font-size:20px;">
                                        <strong class="font-bold">魔方</strong>
                                    </span>
                                </span>
                        </a>
                    </div>
                    <div class="logo-element">魔方
                    </div>
                </li>
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <@shiro.hasPermission name="system:books:book_management">
                            <li>
                                <a class="J_menuItem" href="${ctx!}/web/books/index">图书管理</a>
                            </li>
                        </@shiro.hasPermission>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
                    ...
                    <li class="dropdown">
                        <a class="dropdown-toggle count-info" data-toggle="dropdown" href="#">
                            <span class="glyphicon glyphicon-user" aria-hidden="true"></span> <span
                                    class="label label-primary"></span>【<@shiro.principal type="net.bubblyyi.base.entity.User" property="userCode"/>
                            】
                        </a>
                            ...
                            <li>
                                <a href="${ctx!}/admin/logout">
                                    <div>
                                        ...
                                        <span class="pull-right text-muted small"><@shiro.principal type="net.bubblyyi.base.entity.User" property="userName"/></span>
                                    </div>
                                </a>
                            </li>
                        </ul>
        ...
        <div class="row J_mainContent" id="content-main">
            <iframe id="J_iframe" width="100%" height="100%" src="${ctx!}/admin/welcome"
